...
#define STRING_CONFIG_H_AUTHOR "(Csaba Keleti, 235x235 with Bltouch)" // Who made the changes.
...
//  #define DEFAULT_bedKd 322.28
  #define DEFAULT_bedKp 47.28
  #define DEFAULT_bedKi 7.21
  #define DEFAULT_bedKd 77.46
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define BACK_PROBE_BED_POSITION 210   //(Y_BED_SIZE - MIN_PROBE_EDGE)
