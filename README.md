...
This code is a "vanilla" Marlin 1.1.9.1 for the Geeetech A10 printer (Mainboard: BOARD_GT2560_V3_0).

board.h, pins.h and pins_GT2560_V3.0.h was modified/created to support the GT2560_V3.0 board.
